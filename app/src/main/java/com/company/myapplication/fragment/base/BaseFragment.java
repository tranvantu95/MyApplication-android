...
public abstract class BaseFragment<Model extends ViewModel> extends Fragment {
    ...
    // Model
    protected <MyModel extends ViewModel> MyModel getAppModel(Class<MyModel> clazz) {
        return ModelUtils.ofApp(getActivity().getApplication()).get(clazz);
    }

    protected <MyModel extends ViewModel> MyModel getActivityModel(Class<MyModel> clazz) {
        return ModelUtils.of(getActivity()).get(clazz);
    }

    protected <MyModel extends ViewModel> MyModel getParentFragmentModel(Class<MyModel> clazz) {
        return ModelUtils.of(getParentFragment()).get(clazz);
    }

    protected <MyModel extends ViewModel> MyModel getFragmentModel(Class<MyModel> clazz) {
        return ModelUtils.of(this).get(clazz);
    }

    protected <MyModel extends ViewModel> MyModel getModel(int owner, Class<MyModel> clazz) {
        switch (owner) {
            case APP_MODEL:
